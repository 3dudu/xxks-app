...
export default {
	...
	methods: {
		...
		showDown(total){
			...
			let m_total = total % 3600;
			this.$set(this.list, 0, Math.floor(hour/10));
			this.$set(this.list, 1, hour%10);
			
			let min = Math.floor(m_total/60);
			this.$set(this.list, 3, Math.floor(min/10));
			this.$set(this.list, 4, min%10);
					
			let s_total = m_total % 60;
			this.$set(this.list, 6, Math.floor(s_total/10));
			this.$set(this.list, 7, s_total%10);
		},
